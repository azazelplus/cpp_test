...
#endif  // VL_DEBUG
VL_ATTR_COLD void Vlight___024root___eval_stl(Vlight___024root* vlSelf);
...
VL_ATTR_COLD void Vlight___024root___eval_settle(Vlight___024root* vlSelf) {
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vlight___024root___eval_triggers__stl(vlSelf);
...
#endif
                VL_FATAL_MT("/home/azazel/verilator_stuff/light_nvboard/vsrc/light.v", 5, "", "Settle region did not converge.");
            }
            vlSelf->__VstlIterCount = ((IData)(1U) 
                                       + vlSelf->__VstlIterCount);
            Vlight___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vlight___024root___dump_triggers__stl(Vlight___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vlight__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlight___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void Vlight___024root___stl_sequent__TOP__0(Vlight___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vlight__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlight___024root___stl_sequent__TOP__0\n"); );
    // Body
    vlSelf->led = vlSelf->light__DOT__led_reg;
}

VL_ATTR_COLD void Vlight___024root___eval_stl(Vlight___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vlight__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlight___024root___eval_stl\n"); );
    // Body
    if (vlSelf->__VstlTriggered.at(0U)) {
        Vlight___024root___stl_sequent__TOP__0(vlSelf);
    }
}
