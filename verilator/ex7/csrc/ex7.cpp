// ========== 配置区：只需修改这一行 ==========
#define V_MODULE_NAME Vtop
// ============================================

// 宏拼接技巧：用于生成头文件名
#define STRINGIFY(x) #x
#define TOSTRING(x) STRINGIFY(x)
#define MAKE_HEADER(name) TOSTRING(name.h)

// 使用宏包含头文件
#include MAKE_HEADER(V_MODULE_NAME)



//#include "Vlight.h"  // 旧的包含方式示例
#include "verilated.h"
#include <iostream>
...
void nvboard_bind_all_pins(V_MODULE_NAME* top);  //绑定引脚的声明.
