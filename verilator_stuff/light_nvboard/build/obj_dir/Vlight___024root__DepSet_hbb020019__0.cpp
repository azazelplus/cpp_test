...
VL_INLINE_OPT void Vlight___024root___nba_sequent__TOP__0(Vlight___024root* vlSelf) {
    ...
    // Init
    SData/*15:0*/ __Vdly__light__DOT__led_reg;
    __Vdly__light__DOT__led_reg = 0;
    IData/*31:0*/ __Vdly__light__DOT__count;
    __Vdly__light__DOT__count = 0;
    // Body
    __Vdly__light__DOT__count = vlSelf->light__DOT__count;
    __Vdly__light__DOT__led_reg = vlSelf->light__DOT__led_reg;
    if (vlSelf->rst) {
        __Vdly__light__DOT__led_reg = 1U;
        __Vdly__light__DOT__count = 0U;
    } else {
        if ((0U == vlSelf->light__DOT__count)) {
            __Vdly__light__DOT__led_reg = ((0xfffeU 
                                            & ((IData)(vlSelf->light__DOT__led_reg) 
                                               << 1U)) 
                                           | (1U & 
                                              ((IData)(vlSelf->light__DOT__led_reg) 
                                               >> 0xfU)));
    ...
    vlSelf->light__DOT__led_reg = __Vdly__light__DOT__led_reg;
...
#endif
                    VL_FATAL_MT("/home/azazel/verilator_stuff/light_nvboard/vsrc/light.v", 5, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/azazel/verilator_stuff/light_nvboard/vsrc/light.v", 5, "", "NBA region did not converge.");
            }
