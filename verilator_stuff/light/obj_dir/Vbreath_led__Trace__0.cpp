...
void Vbreath_led___024root__trace_chg_sub_0(Vbreath_led___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vbreath_led___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbreath_led___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vbreath_led___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vbreath_led___024root__trace_chg_sub_0(Vbreath_led___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vbreath_led__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbreath_led___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+4,(vlSelf->light__DOT__cycle_count),32);
}

void Vbreath_led___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbreath_led___024root__trace_cleanup\n"); );
    // Init
    Vbreath_led___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vbreath_led___024root*>(voidSelf);
    Vbreath_led__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
