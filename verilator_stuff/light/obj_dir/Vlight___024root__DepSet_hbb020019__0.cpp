...
VL_INLINE_OPT void Vlight___024root___nba_sequent__TOP__0(Vlight___024root* vlSelf) {
    ...
    IData/*31:0*/ __Vdly__light__DOT__cycle_count;
    __Vdly__light__DOT__cycle_count = 0;
    // Body
    __Vdly__light__DOT__cycle_count = vlSelf->light__DOT__cycle_count;
    __Vdly__light__DOT__count = vlSelf->light__DOT__count;
    __Vdly__led = vlSelf->led;
    if ((1U & (~ (IData)(vlSelf->rst)))) {
        __Vdly__light__DOT__cycle_count = ((IData)(1U) 
                                           + vlSelf->light__DOT__cycle_count);
    }
    if (VL_UNLIKELY((0x186a0U == vlSelf->light__DOT__cycle_count))) {
        VL_FINISH_MT("light.v", 22, "");
    }
    if (vlSelf->rst) {
        __Vdly__led = 1U;
    ...
    vlSelf->light__DOT__cycle_count = __Vdly__light__DOT__cycle_count;
...
#endif
                    VL_FATAL_MT("light.v", 3, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("light.v", 3, "", "NBA region did not converge.");
            }
